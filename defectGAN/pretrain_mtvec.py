...
if __name__ == '__main__':
    ...
    train()
    '''
    python pretrain_mtvec.py --name mae_mtvec --dataset_name mtvec --dataset_data_type pill --phase val --add_noise --use_spectral --lr 1.5e-4 5e-4 --patch_size 8 --mask_token_type zero --diff_aug color,translation,cutout
    ...
    python train_mae.py --name mae_shrink_sean_embed --data_dir A:/research/data --phase val --add_noise --use_spectral --lr 1.5e-4 5e-4 --patch_size 16 --embed_path results/vit_shrink/latest_train_fusion_embeddings.pth --dataset_name codebrim_shrink --style_norm_block_type sean
    '''
